...
- And judge $i$'s expected utility of enacting $p$ is $$ EU_i(p; \alpha_i, \beta_i, \kappa) = {\color{DarkGreen}p\alpha_i} + {\color{Blue}\left( 1 - {\color{LightOrange}\Lambda(\hat{\kappa}_i)}\, {\color{BurntOrange}p^2} \right)\beta_i},$$ where $\hat{\kappa}_i = \frac{s_i \tau_i}{\tau_i + 1}$
